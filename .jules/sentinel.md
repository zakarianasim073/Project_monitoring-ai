...
## 2026-04-17 - CI Infrastructure Fix
**Vulnerability:** Not a security vulnerability, but a CI failure.
**Learning:** CI workflow must target the `backend` directory explicitly for builds in this project structure.
**Prevention:** Ensure GitHub Actions workflows are aligned with the monorepo-style directory structure.
