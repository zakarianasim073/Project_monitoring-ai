      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden">
        <div className="p-10">
          ...
          <div className="mt-8 text-center text-xs text-slate-500">
            <p className="mb-2 uppercase tracking-wider font-semibold">Quick Demo Login</p>
            <div className="flex flex-col gap-2">
              <button
                type="button"
                onClick={() => handleDemoLogin('director@buildtrack.bd')}
                className="px-4 py-2 bg-slate-50 hover:bg-blue-50 hover:text-blue-600 rounded-xl border border-slate-200 transition-colors"
              >
