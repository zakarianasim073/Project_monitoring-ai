    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden">
        <div className="p-10">
          ...
          <div className="mt-8">
            <p className="text-center text-xs text-slate-500 mb-3 font-medium uppercase tracking-wider">Demo Accounts</p>
            <div className="flex flex-col gap-2">
              <button
                type="button"
                onClick={() => fillDemo('director@buildtrack.bd', '123456')}
                className="text-xs text-slate-600 bg-slate-50 hover:bg-slate-100 py-2 px-4 rounded-xl border border-slate-200 transition-all text-left flex justify-between items-center group"
              >
                <span>director@buildtrack.bd</span>
                <span className="text-slate-400 group-hover:text-blue-600 font-semibold">Director Login</span>
              </button>
              <button
                type="button"
                onClick={() => fillDemo('engineer@buildtrack.bd', '123456')}
                className="text-xs text-slate-600 bg-slate-50 hover:bg-slate-100 py-2 px-4 rounded-xl border border-slate-200 transition-all text-left flex justify-between items-center group"
              >
                <span>engineer@buildtrack.bd</span>
                <span className="text-slate-400 group-hover:text-blue-600 font-semibold">Engineer Login</span>
              </button>
            </div>
          </div>
        </div>
