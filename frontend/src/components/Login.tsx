      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden">
        <div className="p-10">
          ...
          <div className="mt-8 text-center">
            <p className="text-xs text-slate-500 mb-3">Demo Accounts (Click to autofill):</p>
            <div className="flex flex-col gap-2">
              <button
                type="button"
                onClick={() => { setEmail('director@buildtrack.bd'); setPassword('123456'); }}
                className="text-xs bg-slate-100 hover:bg-slate-200 text-slate-600 py-2 px-4 rounded-xl transition-colors font-medium"
              >
                Director: director@buildtrack.bd / 123456
              </button>
              <button
                type="button"
                ...
                className="text-xs bg-slate-100 hover:bg-slate-200 text-slate-600 py-2 px-4 rounded-xl transition-colors font-medium"
              >
                Engineer: engineer@buildtrack.bd / 123456
              </button>
            </div>
          </div>
        </div>
