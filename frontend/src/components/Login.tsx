    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden">
        <div className="p-10">
          ...
          <div className="mt-8">
            <p className="text-center text-xs text-slate-500 mb-4">Quick Demo Login:</p>
            <div className="flex gap-3">
              <button
                type="button"
                onClick={() => handleQuickLogin('director@buildtrack.bd', '123456')}
                className="flex-1 py-2 px-3 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl text-xs font-medium transition-colors border border-slate-200"
              >
                Director
              </button>
              <button
                type="button"
                onClick={() => handleQuickLogin('engineer@buildtrack.bd', '123456')}
                className="flex-1 py-2 px-3 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl text-xs font-medium transition-colors border border-slate-200"
              >
                Engineer
              </button>
