      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden">
        <div className="p-10">
          ...
          <div className="mt-8 border-t pt-6">
            <p className="text-center text-xs font-semibold text-slate-500 uppercase tracking-wider mb-4">Quick Login (Demo)</p>
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                onClick={() => { setEmail('director@buildtrack.bd'); setPassword('123456'); }}
                className="flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-slate-600 bg-slate-100 hover:bg-slate-200 rounded-xl transition-colors"
              >
                Director
              </button>
              <button
