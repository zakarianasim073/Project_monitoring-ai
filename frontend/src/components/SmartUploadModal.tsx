  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="border-2 border-dashed rounded-2xl p-10 text-center hover:border-emerald-500 transition-colors focus-within:ring-2 focus-within:ring-emerald-500 focus-within:ring-offset-2">
