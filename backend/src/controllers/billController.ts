...
export const createBill = async (req: Request, res: Response) => {
  try {
    ...
    // PERFORMANCE: Use updateOne with $push to avoid hydrating the entire project document
    // Architectural Pattern: Sequential update for entity-parent relationship integrity
    ...
    if (billData.type === 'CLIENT_RA' && billData.documentId) {
      ...
      // PERFORMANCE: Use countDocuments and updateMany to avoid N+1 save() loop
