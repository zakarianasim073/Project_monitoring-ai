...
export const createDPR = async (req: Request, res: Response) => {
  try {
    ...
    // 2. Auto-update BOQ executed quantity (if linked) - Atomic update to prevent N+1 and hydration
    ...
    // 3. Auto-deduct material stock - Atomic batch update with clamping to prevent negative stock
    ...
    // 4. Auto-create subcontractor liability (if linked) - Optimized lookup
    ...
    // 5. Add DPR and Liability to project in one atomic update
