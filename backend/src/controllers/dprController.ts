...
export const createDPR = async (req: Request, res: Response) => {
  try {
    ...
    // OPTIMIZATION: Atomic update with $inc and project scoping for BOLA
    ...
    if (dprData.subContractorId && dprData.workDoneQty && dprData.linkedBoqId) {
      // OPTIMIZATION: Project only necessary fields and scope by project for BOLA
    ...
    // OPTIMIZATION: Consolidated atomic update to minimize database roundtrips
    ...
    console.error(error);
    // Sentinel standard: Generic 'Internal server error' to prevent info leakage
