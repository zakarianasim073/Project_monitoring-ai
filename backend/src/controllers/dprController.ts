...
export const createDPR = async (req: Request, res: Response) => {
  try {
    ...
    // OPTIMIZATION: Atomic update via $inc instead of findById -> save loop
    ...
    // OPTIMIZATION: Use bulkWrite with aggregation pipeline for atomic stock clamping to 0 in one roundtrip
    ...
    // OPTIMIZATION: Parallelize all database operations
