...
export const createDPR = async (req: Request, res: Response) => {
  try {
    ...
    // OPTIMIZATION: Use atomic update to avoid hydration and race conditions
    ...
    // OPTIMIZATION: Use .lean() for faster read-only query
    ...
    // 5. Consolidate project updates into a single atomic call
