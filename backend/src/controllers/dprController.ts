...
export const createDPR = async (req: Request, res: Response) => {
  try {
    ...
    // SECURITY: Scope boqItem lookup by projectId to prevent BOLA/IDOR
    ...
    // SECURITY: Scope material lookup by projectId to prevent BOLA/IDOR
    ...
    // SECURITY: Scope subCon lookup by projectId to prevent BOLA/IDOR
