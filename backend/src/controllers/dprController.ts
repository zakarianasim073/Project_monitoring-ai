...
export const createDPR = async (req: Request, res: Response) => {
  try {
    ...
    // 3. Auto-deduct material stock - Use bulkWrite to eliminate N+1 queries
    ...
    // 5. Atomic update to project: Add DPR and Liability in one go
    ...
    // Execute all non-blocking tasks in parallel
