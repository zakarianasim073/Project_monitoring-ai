...
export const createDPR = async (req: Request, res: Response) => {
  try {
    ...
    // 2. Auto-update BOQ executed quantity (if linked) - Atomic optimization
    ...
    // 3. Auto-deduct material stock - Atomic batch optimization
    ...
    if (dprData.subContractorId && dprData.workDoneQty && dprData.linkedBoqId) {
      ...
      if (subCon) {
        ...
        liabilityIds.push(newLiability._id as any);
      }
    }

    // 5. Consolidate project updates - Link DPR and Liabilities in one go
