...
export const createDPR = async (req: Request, res: Response) => {
  try {
    ...
    // OPTIMIZATION: bulkWrite reduces database roundtrips to ONE call
    ...
    if (dprData.subContractorId && dprData.workDoneQty && dprData.linkedBoqId) {
      // Use .select() to minimize hydration overhead
    ...
    // OPTIMIZATION: Consolidated update call avoids multiple project.save() and full hydration
