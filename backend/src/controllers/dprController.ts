...
export const createDPR = async (req: Request, res: Response) => {
  try {
    ...
    // 3. Auto-deduct material stock - PERFORMANCE: Use bulkWrite with aggregation for atomic clamping
    ...
    // 5. Consolidated Project Update - PERFORMANCE: Avoid multiple .save() calls on Project document
