...
export const createDPR = async (req: Request, res: Response) => {
  try {
    ...
    // OPTIMIZATION: Use .exists() to avoid hydrating large project arrays (boq, dprs, materials, etc.)
    ...
    // OPTIMIZATION: Use atomic update to avoid heavy hydration and potential race conditions
    ...
    // OPTIMIZATION: Use bulkWrite with aggregation pipeline to eliminate N+1 queries and ensure atomic clamping
    ...
    // OPTIMIZATION: Use atomic update to link DPR and Liability instead of heavy hydration and multiple saves
