...
export const createDPR = async (req: Request, res: Response) => {
  try {
    ...
    // OPTIMIZATION: Use updateOne for atomic update without hydration
    ...
    // OPTIMIZATION: Use bulkWrite with aggregation pipeline for atomic stock clamping and single DB roundtrip
    ...
    // 5. Add DPR to project and execute all updates in one call
    // OPTIMIZATION: Consolidate multiple Project updates into a single atomic operation
