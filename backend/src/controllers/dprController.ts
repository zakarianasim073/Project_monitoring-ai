...
export const createDPR = async (req: Request, res: Response) => {
  try {
    ...
    // OPTIMIZATION: Use atomic $inc to eliminate roundtrip and ensure data integrity
    ...
    // OPTIMIZATION: Use bulkWrite with aggregation pipeline for atomic, clamped stock updates in one roundtrip
    ...
    // OPTIMIZATION: Use a single updateOne with multi-field $push to minimize roundtrips and avoid hydrating large project arrays
