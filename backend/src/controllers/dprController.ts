...
export const createDPR = async (req: Request, res: Response) => {
  try {
    ...
    // 3. Batch material updates with atomic stock clamping via aggregation pipeline
    ...
    if (dprData.subContractorId && dprData.workDoneQty && dprData.linkedBoqId) {
      // Optimize lookup by selecting only necessary fields
    ...
    // 5. Consolidated project update to link DPR and Liability
