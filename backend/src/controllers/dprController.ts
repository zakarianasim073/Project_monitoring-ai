...
export const createDPR = async (req: Request, res: Response) => {
  try {
    ...
    // Track project updates to batch them into a single call
    ...
    // 3. Auto-deduct material stock - BULK ATOMIC UPDATE (Eliminates N+1 loop)
    ...
    // 5. Finalize project updates in one call
